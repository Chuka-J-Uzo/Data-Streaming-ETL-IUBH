...
producer_config = {'bootstrap.servers': '127.0.0.1:9092', # specifies the Kafka broker address and port number.
                   ...
                   'queue.buffering.max.messages': 1300000, # Maximum number of messages guaranteed to be delivered to Kafka every time.
                   'queue.buffering.max.kbytes': 2000000, # Maximum total size of messages buffered in memory by the producer.
